...
class L10nCs extends L10n {
  ...
  @override
  String get customizeHomePage => 'Přizpůsobit Domovskou Stránku';
  ...
  String get noSongsYet =>
      'Vypadá to, že v knihovně nemáte žádné skladby: Přejděte do nastavení, přidejte své složky s hudbou a aktualizujte si svou knihovnu.';
  ...
  @override
  String get updateLibrary => 'Aktualizovat knihovnu';

  @override
  String artistsAlbumsSongs(int artistCount, int albumCount, int songCount) {
    return '$artistCount umělců, $albumCount alb, $songCount písní';
  }
  ...
  @override
  String get manageLibraryFolders => 'Správa složek knihovny';

  @override
  String get allowedFileExtensions => 'Povolené koncovky souborů';

  @override
  String get allowedFileExtensionsDescription =>
      'Čárkami rozdělený seznam povolených koncovek souborů. Kapitalizovaná či nekapitalizovaná písmena nezáleží. Pokud si nejste jisti, použijte výchozí.';

  @override
  String get manageBlockedFiles => 'Spravovat blokované soubory';

  @override
  String numberOfBlockedFiles(int blockedFiles) {
    return 'Počet zablokovaných souborů: $blockedFiles';
  }
  ...
  @override
  String get playAlbumsInOrder => 'Přehrát alba za sebou';

  @override
  String get playAlbumsInOrderDescription =>
      'Když klinete na skladbu v albu, skladby se přehrají popořadě místo zanechání předchozího režimu přehrávání.';

  @override
  String countSongsPlayed(int percentage) {
    return 'Považovat skladbu za přehranou po: $percentage%';
  }

  @override
  String get libraryFolders => 'Složky Knihovny';

  @override
  String get blockedFiles => 'Blokované Soubory';

  @override
  String get homeCustomization => 'Přizpůsobení Domovské Stránky';

  @override
  String get albumOfTheDay => 'Album Dne';

  @override
  String get artistOfTheDay => 'Umělec Dne';

  @override
  String get shuffleAll => 'Přehrát Vše Přeházeně';

  @override
  String get history => 'Historie';

  @override
  String get addWidgetToHome => 'Přídat Widget na Vaší Domovskou Stránku';

  @override
  String get noPlaylistsYet =>
      'Zatím žádné playlisty. Můžete je přidat v knihovně.';

  @override
  String get lastPlayed => 'Naposledy přehráno';

  @override
  String get noHistoryYet => 'Zatím tu není nic k vidění. Přehrajte něco.';
