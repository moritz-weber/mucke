...
class L10nMs extends L10n {
  ...
  @override
  String get customizeHomePage => 'Sesuaikan Laman Utama';
  ...
  String get noSongsYet =>
      'Nampaknya anda tidak mempunyai sebarang lagu dalam pustaka anda: Pergi ke tetapan, tambah folder muzik anda, dan kemas kini pustaka anda.';
  ...
  @override
  String get manageLibraryFolders => 'Menguruskan folder pustaka';
  ...
  String get allowedFileExtensionsDescription =>
      'Senarai dipisahkan koma. Huruf kecil atau huruf besar tidak penting.';

  @override
  String get manageBlockedFiles => 'Urus fail yang disekat';

  @override
  String numberOfBlockedFiles(int blockedFiles) {
    return 'Bilangan fail yang disekat pada masa ini: $blockedFiles';
  }

  @override
  String get playback => 'Main balik';

  @override
  String get playAlbumsInOrder => 'Mainkan album mengikut urutan';

  @override
  String get playAlbumsInOrderDescription =>
      'Apabila anda mengklik lagu dalam album, lagu-lagu akan dimainkan mengikut turutan dan bukannya mengekalkan mod main sebelumnya.';
